 ...
 *
 * @link https://github.com/jnvsor/adminer-table-header-scroll/blob/master/table-header-scroll.php
 */
class AdminerTableHeaderScroll
{
    public function head()
    {
        ...
        switch ($sDesign) {
            case 'esterka':
            case 'ng9':           $sHeight = '46px'; break;
            case 'haeckel':       $sHeight = '35px'; break;
            case 'lucas-sandery': $sHeight = '80px'; break;
            default:              $sHeight = '';
        }
        ?>
        <script<?php echo nonce(); ?>>
            function tableHeaderPositionUpdate(){
                ...
                for (var i = 0; i < tables.length; i++) {
                    ...
                    <? if ($sHeight): ?>
                        tableHeader.style.height = '<?=$sHeight?>';
                    <? endif; ?>
